...
var visitDirectory = (directory, visitor) => fs.readdirSync(directory).forEach(function(filename) {
...
task("clean", "removes any js files which were compiled from coffeescript", () => visitDirectory(__dirname, function(filepath) {
  let coffeeFile;
