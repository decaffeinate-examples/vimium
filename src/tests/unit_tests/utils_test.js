...
context('createSearchUrl',
  should('replace %S without encoding', () => assert.equal('https://www.github.com/philc/vimium/pulls', Utils.createSearchUrl('vimium/pulls', 'https://www.github.com/philc/%S'))));
